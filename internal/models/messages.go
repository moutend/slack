...
var MessageWhere = struct {
	...
	User:             whereHelperstring{field: "\"messages\".\"user\""},
	Text:             whereHelperstring{field: "\"messages\".\"text\""},
	Timestamp:        whereHelperstring{field: "\"messages\".\"timestamp\""},
	ThreadTimestamp:  whereHelperstring{field: "\"messages\".\"thread_timestamp\""},
	IsStarred:        whereHelperbool{field: "\"messages\".\"is_starred\""},
	LastRead:         whereHelperstring{field: "\"messages\".\"last_read\""},
	Subscribed:       whereHelperbool{field: "\"messages\".\"subscribed\""},
	UnreadCount:      whereHelperint64{field: "\"messages\".\"unread_count\""},
	SubType:          whereHelperstring{field: "\"messages\".\"sub_type\""},
	Hidden:           whereHelperbool{field: "\"messages\".\"hidden\""},
	DeletedTimestamp: whereHelperstring{field: "\"messages\".\"deleted_timestamp\""},
	EventTimestamp:   whereHelperstring{field: "\"messages\".\"event_timestamp\""},
	BotID:            whereHelperstring{field: "\"messages\".\"bot_id\""},
...
func FindMessage(ctx context.Context, exec boil.ContextExecutor, timestamp string, selectCols ...string) (*Message, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"messages\" where \"timestamp\"=?", sel,
	)
...
func MessageExists(ctx context.Context, exec boil.ContextExecutor, timestamp string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"messages\" where \"timestamp\"=? limit 1)"
