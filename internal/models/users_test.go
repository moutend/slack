...
var (
	userDBTypes = map[string]string{`ID`: `STRING`, `TeamID`: `STRING`, `Name`: `STRING`, `Deleted`: `BOOLEAN`, `Color`: `STRING`, `RealName`: `STRING`, `TZ`: `STRING`, `TZLabel`: `STRING`, `TZOffset`: `INTEGER`, `CreatedAt`: `DATETIME`, `UpdatedAt`: `DATETIME`}
	_           = bytes.MinRead
)
