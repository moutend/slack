...
var ChannelWhere = struct {
	...
	IsOpen:             whereHelperbool{field: "\"channel\".\"is_open\""},
	LastRead:           whereHelperstring{field: "\"channel\".\"last_read\""},
	UnreadCount:        whereHelperint64{field: "\"channel\".\"unread_count\""},
	UnreadCountDisplay: whereHelperint64{field: "\"channel\".\"unread_count_display\""},
	IsGroup:            whereHelperbool{field: "\"channel\".\"is_group\""},
	IsShared:           whereHelperbool{field: "\"channel\".\"is_shared\""},
	IsIm:               whereHelperbool{field: "\"channel\".\"is_im\""},
	IsExtShared:        whereHelperbool{field: "\"channel\".\"is_ext_shared\""},
	IsOrgShared:        whereHelperbool{field: "\"channel\".\"is_org_shared\""},
	IsPendingExtShared: whereHelperbool{field: "\"channel\".\"is_pending_ext_shared\""},
	IsPrivate:          whereHelperbool{field: "\"channel\".\"is_private\""},
	IsMpim:             whereHelperbool{field: "\"channel\".\"is_mpim\""},
	...
	IsArchived:         whereHelperbool{field: "\"channel\".\"is_archived\""},
	Topic:              whereHelperstring{field: "\"channel\".\"topic\""},
	Purpose:            whereHelperstring{field: "\"channel\".\"purpose\""},
	IsChannel:          whereHelperbool{field: "\"channel\".\"is_channel\""},
	IsGeneral:          whereHelperbool{field: "\"channel\".\"is_general\""},
	IsMember:           whereHelperbool{field: "\"channel\".\"is_member\""},
	Locale:             whereHelperstring{field: "\"channel\".\"locale\""},
...
func FindChannel(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*Channel, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"channel\" where \"id\"=?", sel,
	)
...
func (o *Channel) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to populate default values for channel")
	}
...
func ChannelExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"channel\" where \"id\"=? limit 1)"
