...
var (
	channelDBTypes = map[string]string{`ID`: `STRING`, `IsOpen`: `BOOLEAN`, `LastRead`: `STRING`, `UnreadCount`: `INT`, `UnreadCountDisplay`: `INT`, `IsGroup`: `BOOLEAN`, `IsShared`: `BOOLEAN`, `IsIm`: `BOOLEAN`, `IsExtShared`: `BOOLEAN`, `IsOrgShared`: `BOOLEAN`, `IsPendingExtShared`: `BOOLEAN`, `IsPrivate`: `BOOLEAN`, `IsMpim`: `BOOLEAN`, `Unlinked`: `INT`, `NameNormalized`: `STRING`, `NumMembers`: `INT`, `User`: `STRING`, `Name`: `STRING`, `Creator`: `STRING`, `IsArchived`: `BOOLEAN`, `Topic`: `STRING`, `Purpose`: `STRING`, `IsChannel`: `BOOLEAN`, `IsGeneral`: `BOOLEAN`, `IsMember`: `BOOLEAN`, `Locale`: `STRING`, `CreatedAt`: `DATETIME`}
	_              = bytes.MinRead
)
